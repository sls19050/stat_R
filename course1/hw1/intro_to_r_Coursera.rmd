...
ggplot(data = arbuthnot, aes(x = year, y = arbuthnot$boys/total)) +
  geom_line() +
  geom_point()
```
...
present <- present %>% mutate(total = present$boys + present$girls)
present <- present %>% mutate(prop_boys = present$boys / present$total)
...
present <- present %>% mutate(more_boys = present$boys > present$girls)
...
present <- present %>% mutate(prop_boy_girl = present$boys / present$girls)
