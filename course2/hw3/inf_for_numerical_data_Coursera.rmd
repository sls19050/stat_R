...
ggplot(nc, aes(x=habit, y=gained)) + 
  geom_boxplot()
nc %>%
  group_by(habit) %>%
...
inference(conf_level = .99, y = weeks, data = nc, statistic = "mean", type = "ci", 
          method = "theoretical")
...
ggplot(nc, aes(x=mage, color = mature)) + geom_histogram(fill = "white")
```
